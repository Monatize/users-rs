...
use serde_json::{ Value, json }; // * Return JSON values from the API
...
use crate::types::entry::{success::EntrySuccess, error::{EntryError, Data}, status::StatusCodes}; // * Success Model for API
// Local Imports
